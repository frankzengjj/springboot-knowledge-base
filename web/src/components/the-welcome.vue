    ...
    const getStatistic = () => {
      axios.get("/ebook-snapshot/get-statistic").then((response) => {
        ...
        if (data.success) {
          ...
          statistic.value.viewCount =
            statisticResp.length > 1
              ? statisticResp[1].viewCount
              : statisticResp[0].viewCount;
          statistic.value.voteCount =
            statisticResp.length > 1
              ? statisticResp[1].voteCount
              : statisticResp[0].voteCount;
          statistic.value.todayViewCount =
            statisticResp.length > 1
              ? statisticResp[1].viewIncrease
              : statisticResp[0].viewIncrease;
          statistic.value.todayVoteCount =
            statisticResp.length > 1
              ? statisticResp[1].voteIncrease
              : statisticResp[0].voteIncrease;
          ...
          statistic.value.todayViewIncrease = parseInt(
            String(
              statisticResp.length > 1
                ? statisticResp[1].viewIncrease
                : statisticResp[0].viewIncrease / nowRate
            )
          );
